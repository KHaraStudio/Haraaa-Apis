...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] bg-dots flex flex-col items-center justify-center px-4">
      ...
      <div className="glass rounded-2xl p-8 w-full max-w-md relative animate-up">
        <h1 className="display text-2xl font-bold text-white mb-1">Selamat Datang Kembali</h1>
        <p className="text-slate-400 text-sm mb-7">Masuk untuk mengakses API key dan dashboard-mu.</p>
        ...
        <p className="mt-6 text-center text-slate-500 text-sm">
          Belum punya akun?{" "}
          <Link href="/register" className="text-teal-400 hover:text-teal-300 transition-colors">Daftar gratis</Link>
        </p>
      </div>
    </div>
  );
